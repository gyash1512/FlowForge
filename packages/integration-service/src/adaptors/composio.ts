...
const TOOL_MAP: Record<string, Record<string, string>> = {
  ...
  whatsapp: {
    ...
    sendTemplate: 'WHATSAPP_SEND_TEMPLATE',
    sendMedia: 'WHATSAPP_SEND_MEDIA_MESSAGE',
    getProfile: 'WHATSAPP_GET_BUSINESS_PROFILE',
    markRead: 'WHATSAPP_MARK_MESSAGE_AS_READ',
  },
  twilio: {
    sendSms: 'TWILIO_SEND_SMS',
    makeCall: 'TWILIO_MAKE_CALL',
    sendWhatsapp: 'TWILIO_SEND_WHATSAPP_MESSAGE',
    lookupNumber: 'TWILIO_LOOKUP_PHONE_NUMBER',
    getCallLog: 'TWILIO_GET_CALL_LOG',
  },
  sendgrid: {
    sendEmail: 'SENDGRID_SEND_AN_EMAIL',
    addContact: 'SENDGRID_ADD_OR_UPDATE_A_CONTACT',
    createList: 'SENDGRID_CREATE_A_LIST',
    addToList: 'SENDGRID_ADD_A_SINGLE_RECIPIENT_TO_A_LIST',
    getStats: 'SENDGRID_GET_GLOBAL_EMAIL_STATISTICS',
  },
  zoom: {
    createMeeting: 'ZOOM_CREATE_A_MEETING',
    listMeetings: 'ZOOM_LIST_MEETINGS',
    getMeeting: 'ZOOM_GET_A_MEETING',
    deleteMeeting: 'ZOOM_DELETE_A_MEETING',
    listRecordings: 'ZOOM_LIST_ALL_RECORDINGS',
  },
  mailchimp: {
    addMember: 'MAILCHIMP_ADD_MEMBER_TO_LIST',
    createCampaign: 'MAILCHIMP_CREATE_A_CAMPAIGN',
    sendCampaign: 'MAILCHIMP_SEND_A_CAMPAIGN',
    getListMembers: 'MAILCHIMP_GET_LIST_MEMBERS_INFO',
    addTag: 'MAILCHIMP_ADD_TAG_TO_MEMBER',
  },
  calendly: {
    listEvents: 'CALENDLY_LIST_EVENTS',
    getEvent: 'CALENDLY_GET_EVENT',
    listEventTypes: 'CALENDLY_LIST_EVENT_TYPES',
    cancelEvent: 'CALENDLY_CANCEL_EVENT',
    getInvitee: 'CALENDLY_GET_INVITEE',
  },
  email: {
